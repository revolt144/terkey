...
if __name__=='__main__':
    ...
    while t.is_alive():
        for i in "-\|/-\|/":
            ...
            sleep(0.1)
    banner()
    print(c+'Silahkan hubungi '+a+'https://wa.me/+6283164445159'+c+' jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
